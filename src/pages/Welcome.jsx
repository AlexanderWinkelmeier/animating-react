...
export default function WelcomePage() {
  ...
  // scrollY: gibt die Pixel an, wenn man nach unten scrollt
  // erstes Array: wieviele Pixel hat man nach unten gescrollt
  // zweites Array: wieviele Pixel ändet sich yCity, opacityCity ... entsprechend
